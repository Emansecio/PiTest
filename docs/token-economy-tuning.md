...
| `PIT_SUBAGENT_MAX_BYTES` | Teto em bytes da saída que um subagente injeta no contexto pai (cauda mantida; output completo fica em memória). | `24 576` (24 KB) | `built-ins/coordinator-extension.ts:230` | numérica (inteiro positivo) |
