...
| `engineeringStyle` | `"default"` (no-op) or `"karpathy"` (assumptions, root-cause identification, solution-ladder simplicity, surgical edits, goal-driven execution). See `docs/adr/0004-karpathy-engineering-style.md`. |
