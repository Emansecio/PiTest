...
export interface OpenAICompletionsCompat {
	...
	/** Whether the provider rejects `reasoning_effort` when the request also carries tools; when true the field is omitted for tool requests. Default: false. */
	rejectsReasoningEffortWithTools?: boolean;
