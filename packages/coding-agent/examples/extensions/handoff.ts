...
import { complete, type Message } from "@pit/ai";
import type { ExtensionAPI, SessionEntry } from "@pit/coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@pit/coding-agent";
