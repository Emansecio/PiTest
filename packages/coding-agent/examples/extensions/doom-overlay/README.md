...
Play DOOM as an overlay in pit. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
pit --extension ./examples/extensions/doom-overlay
```
...
- [pi-doom](https://github.com/pituned/pi-doom) for the original pit integration
