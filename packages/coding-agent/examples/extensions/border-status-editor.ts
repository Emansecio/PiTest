import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@pit/coding-agent";
import type { Component, EditorTheme, TUI } from "@pit/tui";
