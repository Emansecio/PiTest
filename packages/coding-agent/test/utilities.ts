...
import { getModel, type OAuthCredentials, type OAuthProviderId } from "@pit/ai";
...
// ============================================================================
// OAuth API key resolution from ~/.pit/agent/auth.json
// ============================================================================
...
/**
 * Resolve API key for a provider from ~/.pit/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.pit/agent/auth.json
 */
...
export const PIT_AGENT_DIR = join(homedir(), ".pit", "agent");

/**
 * Get an AuthStorage instance backed by ~/.pit/agent/auth.json
