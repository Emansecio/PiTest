/** Built-in DAP adapter definitions eligible for auto-detection. */
// biome-ignore-all format: large generated table, keep source shape
const DAP_DEFAULTS = {
	"gdb": {
		"command": "gdb",
		"args": ["-i", "dap"],
