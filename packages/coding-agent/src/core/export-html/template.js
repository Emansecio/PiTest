    (function() {
      ...
      // Mirrors the canonical formatTokens in src/utils/format-display.ts —
      // this template is standalone JS (no TS imports), so the algorithm is
      // copied verbatim; keep the two in sync.
