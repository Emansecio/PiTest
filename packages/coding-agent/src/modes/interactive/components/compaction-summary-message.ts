 ...
 *
 * Layout (Leva 2): unified `MessageShell` with the bracketed `[compaction]`
 * label carried by the shell and a purple (`gutterCustom`) gutter. The
 * previous `Box(1,1, customMsgBg)` background is gone — gutter only.
 */
