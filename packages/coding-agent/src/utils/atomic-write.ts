 ...
 */
export async function writeFileAtomic(filePath: string, content: string, signal?: AbortSignal): Promise<void> {
	...
	try {
		...
		if (err instanceof Error && err.message === "Operation aborted") throw err;
