> pit can create prompt templates. Ask it to build one for your workflow.
...
Pit loads prompt templates from:

- Global: `~/.pit/agent/prompts/*.md`
- Project: `.pit/prompts/*.md`
- Packages: `prompts/` directories or `pit.prompts` entries in `package.json`
