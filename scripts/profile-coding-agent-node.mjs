...
const agentDirEnvName = "PIT_CODING_AGENT_DIR";
const startupBenchmarkEnvName = "PIT_STARTUP_BENCHMARK";
...
Options:
  ...
  --agent-dir <dir>      Use a specific PIT_CODING_AGENT_DIR for the benchmark run
  --isolated-agent-dir   Use a fresh temporary agent dir instead of the normal one
  --no-offline           Do not force PIT_OFFLINE=1 / PIT_SKIP_VERSION_CHECK=1
